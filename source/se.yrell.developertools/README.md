...
3. Copy `install/se.yrell.developertools_0.1.32.jar` to Developer Studio's `plugins` folder.
...
```text
-javaagent:C:\Temp\se.yrell.developertools_0.1.32.jar
```

or, if the path works in your installation:

```text
-javaagent:C:\Program Files\BMC Software_25_3_Beta\DeveloperStudio\plugins\se.yrell.developertools_0.1.32.jar
```
