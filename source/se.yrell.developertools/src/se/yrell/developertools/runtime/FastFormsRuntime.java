...
public final class FastFormsRuntime {
    ...
    public static boolean shouldDeselectBaseCheckbox(Object checkboxConfig) {
        ...
        if (!deselectBaseCheckbox()) return false;
    ...
    private static long fastNameListCacheMillis() {
        try { return Long.parseLong(System.getProperty("bmc.ds.fastForms.nameCacheMs", "3000")); }
        catch (Throwable t) { return 3000L; }
    }

    private static Set<Integer> allowedValues() {
        String raw = ToolsPreferences.getFastFormsValues();
    ...
    public static void logAlways(String msg) {
        String line = "[DevStudio FastForms] " + msg;
        System.err.println(line);
        try { Log.info(line); } catch (Throwable ignored) {}
    }
    ...
    private static String logFilePath() {
        String configured = System.getProperty("bmc.ds.fastForms.logFile");
